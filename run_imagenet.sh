...
# # Freeze model
# freeze_graph.py \
#     --input_saved_model_dir=experiments/imagenet/mobilenet_v1/train_and_eval/rigl/0.8/20000/80000/1000/0.3/0.1/0.0001/export_dir/1592962857 \
#     --input_binary=True \
#     --input_checkpoint=experiments/imagenet/mobilenet_v1/train_and_eval/rigl/0.8/20000/80000/1000/0.3/0.1/0.0001/model.ckpt-1200960 \
#     --output_node_names=resnet_model/final_dense_1 \
#     --output_graph=experiments/imagenet/mobilenet_v1/backup/frozen_mobilenetv1.pb
#     # --input_graph=experiments/imagenet/mobilenet_v1/train_and_eval/rigl/0.8/20000/80000/1000/0.3/0.1/0.0001/graph.pbtxt \